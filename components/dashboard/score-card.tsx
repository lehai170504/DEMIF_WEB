  ...
  return (
    <Card className="p-6 border-orange-200/50 bg-white">
      <div className="flex items-center justify-between mb-4">
        <h3 className="font-bold text-slate-800">WELE SCORES</h3>
      ...
      <div className="text-center mb-4">
        ...
        <p className="text-sm text-slate-600">
          Xếp hạng <span className="text-red-500 font-semibold">29.113</span> trên tổng số 32.578 học viên của WELE
        </p>
      </div>
    </Card>
  )
