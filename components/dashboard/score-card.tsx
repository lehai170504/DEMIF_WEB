    ...
    <Card className="p-8 border border-gray-200 dark:border-white/10 bg-white dark:bg-[#18181b] rounded-[2.5rem] shadow-2xl relative overflow-hidden group font-mono">
      ...
      <div className="relative z-10">
        ...
        <div className="flex items-center justify-between mb-8">
          ...
          <button className="p-2 rounded-xl bg-gray-100 dark:bg-white/5 hover:bg-gray-200 dark:hover:bg-white/10 text-gray-500 dark:text-zinc-400 hover:text-gray-900 dark:hover:text-white transition-all border border-transparent hover:border-gray-300 dark:hover:border-white/10">
        ...
        <div className="space-y-3 p-4 rounded-2xl bg-gray-50 dark:bg-black/20 border border-gray-200 dark:border-white/5">
          ...
          <p className="text-[9px] font-medium text-gray-500 dark:text-zinc-500 italic text-right">
            * Cần thêm <span className="font-bold text-gray-900 dark:text-white">120 điểm</span> để
            thăng hạng
          </p>
        </div>
      </div>
