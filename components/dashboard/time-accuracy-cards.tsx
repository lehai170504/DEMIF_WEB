...
export function TimeAccuracyCards() {
  return (
    <div className="grid grid-cols-1 gap-4 font-mono">
      {/* Time Card */}
      <Card className="p-6 border border-gray-200 dark:border-white/5 bg-white dark:bg-[#18181b] rounded-[2rem] shadow-lg hover:border-blue-500/20 transition-all group relative overflow-hidden">
        {/* Glow */}
        ...
        <div className="flex items-center gap-3 mb-6 relative z-10">
          ...
          <span className="text-[10px] font-black uppercase tracking-[0.2em] text-gray-500 dark:text-zinc-500">
            Thời gian nghe
          </span>
        </div>
        <div className="text-4xl font-black italic tracking-tighter text-gray-900 dark:text-white leading-none relative z-10">
          00:02:29
        </div>
      </Card>

      {/* Accuracy Card */}
      <Card className="p-6 border border-gray-200 dark:border-white/5 bg-white dark:bg-[#18181b] rounded-[2rem] shadow-lg hover:border-purple-500/20 transition-all group relative overflow-hidden">
        {/* Glow */}
        ...
        <div className="flex items-baseline gap-1 text-gray-900 dark:text-white leading-none relative z-10">
        ...
        {/* Progress bar */}
        <div className="w-full h-1.5 bg-gray-200 dark:bg-black/40 rounded-full mt-5 overflow-hidden border border-gray-300 dark:border-white/5 relative z-10">
