      ...
      <div className="flex-1 overflow-y-auto custom-scrollbar px-3 pb-6">
        <div className="space-y-1">
          {segments.map((seg, i) => {
            ...
            // Clean representation for the playlist preview
            const textPreview = seg.words.map((w: any, index: number) => {
              ...
              return (
                <span key={index} className="text-orange-500/60 font-bold tracking-normal">
                  {"•".repeat(w.length || 4)} 
                </span>
              );
            });
              ...
              >
                ...
                <div className="relative shrink-0 mt-0.5">
                   <div className={cn(
                     ...
                     isActive ? "border-orange-500 text-orange-500 bg-orange-500/10" : "border-gray-200 dark:border-zinc-800 text-gray-400 dark:text-zinc-600"
                   )}>
                     {i + 1}
                   </div>
                   {isCompleted && (
                ...
                <div className="flex-1 min-w-0 pr-4">
                  ...
                  <div className={cn(
                    ...
                    isActive ? "text-gray-900 dark:text-white font-semibold" : "text-gray-500 dark:text-zinc-500 font-medium group-hover:text-gray-700 dark:group-hover:text-zinc-300"
                  )}>
                    {textPreview}
                  </div>
                </div>
