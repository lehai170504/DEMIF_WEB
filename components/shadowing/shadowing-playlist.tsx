      ...
      <div className="p-6 border-b border-gray-100 dark:border-white/5">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
             ...
             <h3 className="font-bold font-sans text-foreground uppercase text-[12px] tracking-[0.1em]">
               Nội dung bài học
             </h3>
          </div>
      ...
      <div className="flex-1 overflow-y-auto custom-scrollbar px-4 py-6">
        <div className="space-y-3">
          {segments.map((seg, i) => {
            ...
            const runTimeAcc = checkResults[i]?.accuracyScore ?? checkResults[i]?.accuracy;
                  ...
                  <div className="flex items-start gap-3 flex-1 min-w-0">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className={cn(
                        ...
                        !isRevealed ? "blur-md select-none opacity-40" : "opacity-100",
                        isActive ? "text-gray-900 dark:text-white font-bold" : "text-gray-500 dark:text-zinc-400 font-medium"
                      )}>
                        {isRevealed ? seg.text : "••••••••••••••••••••••••••••••••"}
                      </div>
                    </div>
