            ...
            >
              <div
                className={cn(
                  ...
                  "hover:bg-[#202023] hover:border-orange-500/30 hover:shadow-[0_0_30px_-10px_rgba(255,122,0,0.15)]",
                )}
              >
                ...
                {/* Icon Box */}
                <div className="relative flex h-12 w-12 shrink-0 items-center justify-center rounded-xl bg-white/5 border border-white/5 group-hover:border-orange-500/20 group-hover:bg-orange-500/10 transition-all duration-300">
                  <Headset className="h-5 w-5 text-zinc-400 group-hover:text-orange-500 transition-colors" />
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-2 mb-1">
                    <span className="text-[9px] font-black uppercase tracking-widest text-zinc-500 bg-white/5 px-1.5 py-0.5 rounded border border-white/5 group-hover:text-orange-400 group-hover:border-orange-500/20 transition-colors">
                      {lesson.code}
                    </span>
                  </div>
