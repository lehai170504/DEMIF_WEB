      ...
      <div className="flex items-center justify-between px-4 lg:px-6">
        ...
        <Select defaultValue="outline">
          ...
          <SelectContent>
            ...
            <SelectItem value="past-performance">Phân tích Hiệu suất</SelectItem>
        ...
        <TabsList className="**:data-[slot=badge]:bg-muted-foreground/30 hidden **:data-[slot=badge]:size-5 **:data-[slot=badge]:rounded-full **:data-[slot=badge]:px-1 @4xl/main:flex">
          <TabsTrigger value="outline">Danh sách</TabsTrigger>
          <TabsTrigger value="past-performance">
            Hiệu suất <Badge variant="secondary">3</Badge>
          </TabsTrigger>
          <TabsTrigger value="key-personnel">
            Reviewer <Badge variant="secondary">2</Badge>
          </TabsTrigger>
          <TabsTrigger value="focus-documents">Nổi bật</TabsTrigger>
        </TabsList>
