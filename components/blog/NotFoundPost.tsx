...
export function NotFoundPost() {
  return (
    <div className="min-h-screen bg-white dark:bg-[#050505] flex items-center justify-center p-4">
      ...
      <Card className="max-w-xl w-full text-center p-12 border border-gray-200 dark:border-white/10 bg-white dark:bg-[#18181b] rounded-[3rem] shadow-2xl relative overflow-hidden">
        {/* Glow */}
        ...
        <div className="relative z-10">
          <div className="mb-8 flex justify-center">
            <div className="p-6 rounded-3xl bg-gray-100 dark:bg-white/5 border border-gray-200 dark:border-white/5 shadow-inner">
              <FileX className="h-12 w-12 text-gray-400 dark:text-zinc-500" />
            </div>
          </div>
          ...
          <p className="text-gray-600 dark:text-zinc-400 mb-10 leading-relaxed max-w-sm mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button
              asChild
              variant="outline"
              className="h-12 px-6 rounded-xl border-gray-200 dark:border-white/10 bg-transparent text-gray-600 dark:text-zinc-300 hover:text-gray-900 dark:hover:text-white hover:bg-gray-100 dark:hover:bg-white/5 font-bold transition-all"
            >
              <Link href="/blog">
