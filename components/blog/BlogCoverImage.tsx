...
export function BlogCoverImage({
  ...
  return (
    <motion.div
      ...
      className="relative h-[400px] w-full rounded-[2.5rem] mb-10 overflow-hidden border border-gray-200 dark:border-white/10 shadow-2xl group bg-slate-100 dark:bg-[#18181b]"
    >
      {hasValidImage ? (
        // HIỂN THỊ ẢNH THẬT TỪ BE
        <img
          src={thumbnailUrl}
        ...
        // HIỂN THỊ BACKGROUND ICON MẶC ĐỊNH NẾU KHÔNG CÓ ẢNH
        <>
          {/* Background Gradient */}
      ...
      {/* Overlay Gradient (Giúp chữ Badge luôn dễ đọc dù ảnh nền sáng hay tối) */}
