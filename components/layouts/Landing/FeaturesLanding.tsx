        ...
        {features_vi.map((feature, index) => {
          ...
          return (
            <motion.div
              ...
              className="group relative p-8 rounded-3xl bg-white dark:bg-white/5 border border-gray-200 dark:border-white/10 hover:border-[#FF7A00]/50 hover:bg-gray-50 dark:hover:bg-white/[0.08] transition-all duration-300 hover:-translate-y-1 backdrop-blur-sm overflow-hidden shadow-sm dark:shadow-none hover:shadow-lg dark:hover:shadow-none"
            >
              ...
              <h3 className="text-xl md:text-2xl font-bold mb-3 text-gray-900 dark:text-white group-hover:text-[#FF7A00] transition-colors">
                {feature.title}
              </h3>
              <p className="text-gray-600 dark:text-zinc-400 leading-relaxed text-sm md:text-base group-hover:text-gray-700 dark:group-hover:text-zinc-300 transition-colors">
                {feature.description}
              </p>
            </motion.div>
          );
