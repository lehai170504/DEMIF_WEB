  ...
  return (
    ...
    >
      ...
      <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto items-center">
        ...
        >
          <Card className="p-8 bg-white/5 border border-white/10 hover:border-[#FF7A00]/30 transition-all duration-300 hover:-translate-y-2 backdrop-blur-sm rounded-3xl">
            <div className="mb-6">
              <h3 className="text-2xl font-bold mb-2 text-white">Miễn phí</h3>
              <p className="text-zinc-400">Bắt đầu học ngay</p>
            </div>
            <div className="mb-8">
              <div className="flex items-baseline gap-2">
                <span className="text-4xl font-bold text-white">0đ</span>
                <span className="text-zinc-500">/mãi mãi</span>
              </div>
            </div>
            <ul className="space-y-4 mb-8">
              ...
              <li className="flex items-start gap-3 text-zinc-600 text-sm opacity-50">
        ...
        >
          ...
          <Card className="p-8 bg-gradient-to-b from-[#FF7A00]/20 to-black/80 border border-[#FF7A00]/50 relative shadow-2xl shadow-orange-900/40 rounded-3xl transform scale-105 z-10 backdrop-blur-xl">
            ...
            <div className="mb-8 text-center bg-white/5 py-4 rounded-2xl border border-white/10">
        ...
        >
          <Card className="p-8 bg-white/5 border border-white/10 hover:border-[#FF7A00]/30 transition-all duration-300 hover:-translate-y-2 backdrop-blur-sm rounded-3xl">
            <div className="mb-6">
              ...
              <p className="text-zinc-400">Tiết kiệm nhiều nhất</p>
            </div>

            <div className="mb-8">
              <div className="flex items-baseline gap-2">
                <span className="text-4xl font-bold text-white">299K</span>
