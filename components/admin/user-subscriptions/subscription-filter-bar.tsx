      ...
      <div className="flex flex-col sm:flex-row items-center gap-4 w-full md:w-auto">
        ...
        <div className="relative w-full sm:w-80 group">
          ...
          <Input
            ...
            className="h-12 pl-11 bg-white dark:bg-zinc-900/50 border-slate-200 dark:border-white/5 rounded-2xl font-bold text-[11px] tracking-wider focus:border-orange-500 focus:ring-orange-500/10 shadow-sm dark:text-white transition-all"
            value={searchTerm}
        ...
        <Select value={status} onValueChange={onStatusChange}>
          <SelectTrigger className="h-12 w-full sm:w-[200px] bg-white dark:bg-zinc-900/50 border-slate-200 dark:border-white/5 rounded-2xl font-black text-[10px] uppercase tracking-widest shadow-sm dark:text-slate-200 focus:ring-orange-500/10">
          ...
          <SelectContent className="font-mono bg-white dark:bg-zinc-950 border-slate-200 dark:border-white/10 rounded-2xl shadow-2xl">
            ...
            <SelectItem
              ...
              className="text-[10px] font-black uppercase text-orange-600 dark:text-orange-400"
            >
              Chờ thanh toán
            </SelectItem>
            <SelectItem
              value="Expired"
              className="text-[10px] font-black uppercase text-slate-500 dark:text-zinc-500"
            >
              Đã hết hạn
            </SelectItem>
            <SelectItem
              value="Cancelled"
              className="text-[10px] font-black uppercase text-red-600 dark:text-red-400"
            >
              Đã hủy
            </SelectItem>
          </SelectContent>
        ...
        <Button
          ...
          className="h-12 px-6 bg-[#FF7A00] hover:bg-[#FF7A00]/90 text-white rounded-2xl font-black uppercase text-[10px] tracking-[0.2em] shadow-lg shadow-orange-500/20 active:scale-95 group transition-transform whitespace-nowrap"
        >
