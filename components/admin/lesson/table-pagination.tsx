...
export default function TablePagination<TData>({
  ...
  // Lấy tổng số trang hiện có để hiển thị
  ...
  return (
    <div className="flex items-center justify-between px-2 pt-2 pb-4">
      <div className="flex-1 text-xs text-gray-500">
        {/* SỬA CHỮ Ở ĐÂY: Phản ánh đúng số lượng của trang hiện tại */}
        Đã chọn {table.getFilteredSelectedRowModel().rows.length} hàng trên
        trang này.
      </div>
