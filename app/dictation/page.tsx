      ...
      <header className="border-b border-border">
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <h1 className="text-xl font-bold">Dictation Exercises</h1>
          </div>
      ...
      <main className="container mx-auto px-4 py-8">
        <div className="max-w-4xl mx-auto">
          <div className="mb-8">
            ...
            <p className="text-muted-foreground">Select a dictation exercise to practice your listening skills</p>
          </div>
            ...
            {lessons.map((lesson) => (
              <Card key={lesson.id} className="p-6 hover:border-primary/50 transition-colors">
                <div className="flex items-start justify-between gap-4">
                  ...
                  <Button asChild>
                    <Link href={`/dictation/${lesson.id}`}>Start</Link>
                  </Button>
                </div>
              </Card>
            ))}
